<template>
    <div class="container">
        ...
        <AvtoTovar v-if="tovarData && similar.length" similar-route="/katalok/cars-tovar" :similar="similar"
...
//Hooks
const { data: carResponse, get: getCar } = useFetch(`${import.meta.env.VITE_APP_API}/cars/${route.params.id}`)
const { data: similarResponse, get: getSimilar } = useFetch(`${import.meta.env.VITE_APP_API}/cars`)
