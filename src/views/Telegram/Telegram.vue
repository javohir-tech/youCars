    ...
    <div class="container">
        <div class="mt-4">
            <a-form ref="formRef" layout="vertical" :model="formState" :rules="rules" @submit.prevent="fetchTelegram">
                ...
                <a-button @click="fetchTelegram" :disabled="loader" class="mt-3 submit-btn" style="width: 100%;"
                    type="primary">
                    <a-spin v-if="loader" />
                    <p v-else>Send</p>
                </a-button>
...
const rules = {
    ...
    number: [
        ...
        { pattern: /^\+998\d{9}$/, message: 'Please enter a valid Uzbek phone number (+998 XX XXX XX XX).' }
    ],
    email: [
