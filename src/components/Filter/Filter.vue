        ...
        <div class="dropdown-container">
          <div class="filter-item">
            ...
            <a-dropdown
              :placement="yonalish"
              class="my-dropdown"
              v-model="filters.stock.maxPrice"
            >
              <a-button class="dropdown-button">
                <span>{{
                  `${filters.stock.maxPrice} - ${filters.stock.minPrice}` ||
                  priceOptions[0]
                }}</span>
                <span class="dropdown-icon">▼</span>
              </a-button>
              <template #overlay>
                <a-menu class="custom-dropdown-menu">
                  <a-menu-item
                    ...
                    @click="
                      () =>
                        filters.setFilter('maxPrice', price) &&
                        filters.setFilter('minPirce', price)
                    "
                  >
                    {{ `${price}-${price}` }}
                  </a-menu-item>
